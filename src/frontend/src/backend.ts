...
export class Backend implements backendInterface {
    ...
    async addKnowledgeEntry(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addKnowledgeEntry(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteKnowledgeEntry(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getKnowledgeEntries(): Promise<Array<KnowledgeEntry>> {
        if (this.processError) {
            try {
    ...
    async searchKnowledge(arg0: string): Promise<Array<KnowledgeEntry>> {
        if (this.processError) {
            try {
    ...
    async updateKnowledgeEntry(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateKnowledgeEntry(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
